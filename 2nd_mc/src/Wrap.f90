      ...
      Do i=1,Solver%Mesh%NumberOfNodes
        ...
        Var%Values(Var%Perm(i))=TOPACCU%Values(TOPACCU%Perm(i))
        ...
        DJVar%Values(DJVar%Perm(i))=DJDSMBT%Values(DJDSMBT%Perm(i))
      ...
      Do i=1,Solver%Mesh%NumberOfNodes
        ...
        TOPACCU%Values(TOPACCU%Perm(i))=Var%Values(Var%Perm(i))
      End do
